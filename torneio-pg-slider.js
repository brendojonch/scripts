$(document).ready(function() {
    ...
    var conteudoPremio2 = `
        <ul>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023036826350 R$ 500,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022106414589 R$ 100,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023106350750 R$ 100,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022117402995 R$ 100,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2024034733808 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022128604664 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2024035502867 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023025558955 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023048498462 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022106414589 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022129938307 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022117402995 R$ 50,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023015324202 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2024034733808 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023117247245 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022106087168 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023117239350 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022077703755 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022129054117 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022077703755 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023036826350 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023078877759 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023048498462 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022118029876 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023048498462 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2024045689523 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022128622969 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022077712071 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022117402995 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022106539596 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022077712071 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2022117524282 R$ 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 2023071449873 R$ 25,00</li>
        </ul>
    `;
    ...
    var conteudoJogo1 = `
        <div>
            <a href="https://go.aff.upbet.com/zs49baos" class="inner_table unit_panel">
                <div class="unit_image">
                    <img src="https://static.sportingtech.com/common/assets/images/casino/300x200/19533.jpg" class="el-image__inner" style="object-fit: cover;">
                </div>
                <div class="unit_cover">
                    <div class="unit_name">Fortune Tiger</div>
                    <div class="unit_vendor">PG Soft</div>
                </div>
            </a>
        </div>
    `;
    ...
    var conteudoPremio1 = `
        <ul>
            <li><i class="pg-icons fa fa-trophy"></i> - 52370030417008 - 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 52370030417008 - 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 52370030417008 - 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 52370030417008 - 25,00</li>
            <li><i class="pg-icons fa fa-trophy"></i> - 52370030417008 - 25,00</li>
    ...
    var conteudoPremio5 = `
    <ul>
        <li><i class="pg-icons fa fa-trophy"></i> - <i class="pg-icons fa fa-trophy"></i> - R$</li>
        <li><i class="pg-icons fa fa-trophy"></i> - <i class="pg-icons fa fa-trophy"></i> - R$</li>
        <li><i class="pg-icons fa fa-trophy"></i> - <i class="pg-icons fa fa-trophy"></i> - R$</li>
    </ul>
    `;
